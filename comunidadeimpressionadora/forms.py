...
class FormEditarPerfil(FlaskForm):
    ...
    projeto_eletrico_SAA = BooleanField('PEAU Sistema de Água ')
    projeto_eletrico_SES = BooleanField('PEAU Sistema de Esgoto ')
    projeto_eletrico_geral = BooleanField('Projeto elétrico predial/industrial')
...
class FormCriarPost(FlaskForm):
    ...
    corpo = TextAreaField('Escreva seu post aqui... ', validators=[DataRequired(), Length(2, 2000)])
